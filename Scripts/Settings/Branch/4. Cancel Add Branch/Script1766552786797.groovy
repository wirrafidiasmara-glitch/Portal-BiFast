...
WebUI.setText(findTestObject('Menu/Settings/Branch/Add_Branch Name'), 'Test Branch')

WebUI.setText(findTestObject('Menu/Settings/Branch/Add_Branch Code'), '001312')

WebUI.setText(findTestObject('Menu/Settings/Branch/Add_Branch Type'), 'Test_Test')
